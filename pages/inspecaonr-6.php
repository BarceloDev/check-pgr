    ...
    <header class="w-full bg-white shadow-md border-b border-slate-100 sticky top-0 z-50">
      <div class="max-w-[1200px] mx-auto px-6 py-4 flex items-center justify-between">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h1 class="text-base font-bold text-slate-800">Formulário de Inspeção NR-06</h1>
            <p class="text-xs text-slate-400">Inspeção de Equipamentos de Proteção Individual</p>
          </div>
        </div>
        
        <span class="bg-emerald-50 text-emerald-600 font-bold px-3 py-1 rounded-lg text-xs">Setor Ativo</span>
      </div>
    </header>
